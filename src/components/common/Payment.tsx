...
const Payment = ({ onClose }: { onClose: () => void }) => {
  ...
  const handlePayment = () => {
    ...
    alert(`총 ${totalPrice}원 입니다! 결제가 완료되었습니다! 삑~`);
    onClose();
  };
  ...
  const styles = {
    ...
    header: {
      padding: '15px 20px', backgroundColor: '#55c57a', color: 'white', flexShrink: 0,
            ...
            <div style={styles.menuGrid}>
              {products.map(item => (
                <div 
                  ...
                  onMouseEnter={(e) => { if (item.stock > 0) e.currentTarget.style.borderColor = '#55c57a'; }}
